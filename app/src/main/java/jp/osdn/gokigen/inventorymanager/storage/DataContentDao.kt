...
interface DataContentDao
{
    ...
    @Query("UPDATE contents SET title = :title, sub_title = :subTitle, author = :author, publisher = :publisher, description = :description, isbn = :isbn, category = :category, note = :note, update_date = :updateDate WHERE id = :id")
    fun updateContentWithIsbn(id: Long, title: String, subTitle: String, author: String, publisher: String, description: String, isbn: String, category: String, note: String, updateDate: Date)
